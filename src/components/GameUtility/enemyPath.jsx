...
const enemyKeyframesByMap = {
    ...
    { percent: 43.00, x: 1048, y: 524, opacity: 1 },
...
export const getEnemyPath = (mapName) => {
    const keyframes = enemyKeyframesByMap[mapName] || enemyKeyframesByMap['newDawn'];
    const duration = totalDurations[mapName] || totalDurations['newDawn'];
    return keyframes.map((frame) => ({
        time: (frame.percent / 100) * duration,
        x: frame.x,
        y: frame.y,
